...
namespace MediaTek.dal
{
    ...
    public class AccesConnexionBdd
    {
        ...
        /// </summary>
        private static string chaineConnexion = "server=localhost;user id=root;password= ;database=projetcned;SslMode=none";
        ...
        /// </summary>
        /// <returns>Retourne la liste des services existants</returns>
        ...
        /// </summary>
        /// <returns>Retourne la liste des absences d'un personnel</returns>
        ...
        /// </summary>
        /// <returns>Retourne la liste des motfis d'absence</returns>
